 ...
 *
 * hbase.zookeeper.fk.quorum=172.17.qq.87,172.17.qq.88,172.17.qq.89
 * hbase.zookeeper.quorum=172.17.qq.87,172.17.qq.88,172.17.qq.89
 */
public class hbaseTest {
    ...
    public static Connection hbaseConnection() throws Exception {
        ...
        //不填端口,默认2181
        configuration.set("hbase.zookeeper.quorum","172.17.qq.87");
        //获取连接对象
